//-----------------------------------------------------------------------
// <copyright file="CompHelpData.cs" company="None">
//     No copyright
// </copyright>
...
namespace ToCSIII_TBLConverter
{
    ...
    /// <summary>
    /// Provide the structure and some utilities for the 'CompHelpData' objects.
    /// </summary>
    public class CompHelpData : ToCSIII_TBLConverter.Object
    {
        private byte[] unknows;

        /// <summary>
        /// Initializes a new instance of the <see cref="CompHelpData"/> class.
        /// </summary>
        public CompHelpData() : base()
        {
            this.unknows = new byte[4];
        }
        ...
        public CompHelpData(byte[] t_data)
        {
            this.unknows = new byte[4];
        ...
        public CompHelpData(string[] t_string) : base(t_string)
        {
            this.unknows = new byte[4];
